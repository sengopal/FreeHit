...
public class InfoItems {
    ...
    public String getBatstyle(){return batstyle;}
    public String getBowlstyle(){return bowlstyle;}
    public String getTeamsplayed(){return teamsplayed;}
    public String getImg(){return img;}
    public List<String> getManofthematch(){return manofthematch;}

    public List<String> getBatrank(){return batrank;}
    public List<String> getBowlrank(){return bowlrank;}
}
