...
public class SeriesBowlingPerformance extends Fragment  {
    String id="1";
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.series_bowling_list, container, false);
...
/*
        ...
        seriesInfo.enqueue(new Callback<PerformanceItem>() {
            ...
            public void onResponse(Call<PerformanceItem> call, Response<PerformanceItem> response) {
                ...
                recyclerView.setAdapter(new SeriesBowlingAdapter(seriesInfo, R.layout.series_bowling_item, getContext()));
                                           ...
                                           public void onRefresh() {
                                               ...
                                               seriesInfo.enqueue(new Callback<com.debut.ellipsis.freehit.More.Series.PerformanceItem>() {
                                                   ...
                                                   public void onResponse(Call<PerformanceItem> call, Response<PerformanceItem> response) {
                                                       mProgressbar.setVisibility(View.GONE);
                                                       List<PerformanceItem> seriesInfo = response.body().getResults();
                                                       recyclerView.setAdapter(new SeriesBowlingAdapter(seriesInfo, R.layout.fragment_more_series_list_item, getContext()));
