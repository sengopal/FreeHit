...
public class ScoreCardExpandableListDataPump {
    ...
    public static ArrayList<ScoreCardItemListBatting> getDataBattingTeam2() {


        String group_names[] = {"ENG 1st Innings\n294/1(38.0)\nExtras: 6 (B: 0, LB: 0, NB: 0, WD: 6, P: 0)", "ENG 2nd Innings\n288/6(50.0)\nExtras: 6 (B: 0, LB: 0, NB: 0, WD: 6, P: 0)"};
    ...
    public static ArrayList<ScoreCardItemListBatting> getDataBattingTeam1() {


        String group_names[] = {"WI 1st Innings\n288/6(50.0)\nExtras: 11 (B: 0, LB: 2, NB: 0, WD: 9, P: 0)", "WI 2nd Innings\n288/6(50.0)\nExtras: 6 (B: 0, LB: 0, NB: 0, WD: 6, P: 0)"};
    ...
    public static ArrayList<ScoreCardItemListBowling> getDataBowlingTeam2() {


        String group_names[] = {"WI 1st Innings", "WI 2nd Innings"};
    ...
    public static ArrayList<ScoreCardItemListBowling> getDataBowlingTeam1() {


        String group_names[] = {"ENG 1st Innings","ENG 2nd Innings"};
